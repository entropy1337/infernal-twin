...
class create_pdf:
    def add_pdf_text(self, finding_name, phase, findings, risk_level, category_level, PoC_notes):
        data = [
            ...
            [Paragraph(findings, styles["Normal"]), Paragraph('Risk Level', styles["Normal"]),
             Paragraph('Category', styles["Normal"])],
            [Paragraph('Proof of Concept', styles["Normal"]), Paragraph(risk_level, styles["Normal"]),
             Paragraph(category_level, styles["Normal"])],
