...
class SnifferGUI(wx.Frame):
	...
	def onQuitApp(self, event):
		...
		os.system('echo ""> ./Modules/connection_list.txt;echo ""> ./Modules/access_list.txt;echo ""> ./Modules/probe_list.txt')
	...
	def on_timer(self):
		...
		rChannel = randint(1,14)
		os.system('iwconfig mon0 channel %d'%rChannel)
		os.system('touch ./Modules/probe_list.txt; touch ./Modules/connection_list.txt; touch ./Modules/access_list.txt')
