...
class wpa_cracker(wx.Frame):
    ...
    def bruteforce(self, event):
        ...
        os.system(
            "gnome-terminal -x aircrack-ng -w " + self.wordlist + " " + self.capturelist + " -l captures/key_found.txt")
...
class WPA2_crack(wx.Frame):
    ...
    def wireless_scan_cracker(self):
        ...
        os.system("ifconfig wlan0 up")
        read_only_txt = wx.TextCtrl(self, -1, '', style=wx.TE_MULTILINE | wx.TE_READONLY, pos=(20, 200),
                                    size=(400, 600))
        output = str(commands.getstatusoutput("iw wlan0 scan")[1])
