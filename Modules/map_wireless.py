...
class SnifferGUI(wx.Frame):
    ...
    def generateImageAction(self, e):
        ...
        mcommand = "./Modules/airgraph-ng/airgraph-ng -i Modules/Logs/" + str(dumpfilename) + "/" + str(
        ...
        os.system("display ./Modules/Logs/" + str(dumpfilename) + "/" + str(dumpfilename) + ".png")
    ...
    def executeCommand(self, e):
        ...
        try:
            ...
            if attackInterface == 'mon0':
                ...
                os.system("gnome-terminal -- airodump-ng -w ./Modules/Logs/" + str(dumpfilename) + "/" + str(dumpfilename) + " " + attackInterface + "&")
            ...
            # ~ print "gnome-terminal -- aireplay-ng --deauth "+int(myslider)+" -a "+ssidsplitter[0]+" -e "+str(ssidsplitter[1])+" "+attackInterface+" --ignore-negative-one"
                ...
                os.system("gnome-terminal -- airodump-ng -w ./Modules/Logs/" + str(dumpfilename) + "/" + str(dumpfilename) + " mon0")
