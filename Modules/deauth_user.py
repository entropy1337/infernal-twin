    ...
    def executeCommand(self, e):
        ...
        try:
            ...
            if attackInterface == 'mon0':
                ...
                os.system("gnome-terminal -x aireplay-ng --deauth " + str(int(myslider)) + " -a " + ssidsplitter[
            ...
            # ~ print "gnome-terminal -x aireplay-ng --deauth "+int(myslider)+" -a "+ssidsplitter[0]+" -e "+str(ssidsplitter[1])+" "+attackInterface+" --ignore-negative-one"
                ...
                print "gnome-terminal -x aireplay-ng --deauth " + str(int(myslider)) + " -a " + ssidsplitter[
                    0] + " -e " + str(ssidsplitter[2]) + " -c " + str(ssidsplitter[1]) + " mon0 --ignore-negative-one"
