...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        wireless_scan = wx.TextCtrl(pnl, -1, "wireless can results will be displayed here", style=wx.TE_MULTILINE,
                                    pos=(450, 200), size=(400, 300))
        ...
        Notes = wx.TextCtrl(pnl, -1, "Attacker can take notes here", style=wx.TE_MULTILINE, pos=(450, 550),
                            size=(400, 250))

        view_logs = wx.TextCtrl(pnl, -1, 'Logs will be displayed here', style=wx.TE_MULTILINE | wx.TE_READONLY,
                                pos=(880, 200), size=(300, 600))

        myList = ['ssl strip', 'DB logs', 'Credentials', 'CC Info', 'session cookies', 'Media', 'NTLM Hashes']
        combo_box = wx.ComboBox(pnl, id=-1, value="View Logs", pos=(880, 150), size=(160, 30), choices=myList, style=0,
                                name='logs')
