...
class AboutDlg(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, wx.ID_ANY, title="View Project", size=(900, 1000))
...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        cb = wx.ComboBox(pnl, pos=(50, 30), choices=projects, size=(280, 30), value='Select a Project',
    ...
    def OnSelect(self, e):
        ...
        for key, value in projects_id.iteritems():
            if str(value) == str(i):
                ...
                wx.MessageBox('Database is not found', 'Warning/Error', wx.ICON_ERROR)
